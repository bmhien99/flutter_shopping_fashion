...
import 'package:flutter_app_fashion/screens/categories/shirt/product_shirt_page.dart';
import 'package:flutter_app_fashion/screens/feature/product_feature_page.dart';

class ProductCardShirt extends StatelessWidget {
  ...
  ProductCardShirt({this.imageUrl, this.title, this.price, this.productId, this.onPressed});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ProductCategoryShirtPage(productId: productId ,)));
      },
      child: Container(
          child:Column(
