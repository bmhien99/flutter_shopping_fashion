...
import 'package:flutter_app_fashion/screens/categories/jean/product_jean_page.dart';
import 'package:flutter_app_fashion/screens/feature/product_feature_page.dart';

class ProductCardJean extends StatelessWidget {
  ...
  ProductCardJean({this.imageUrl, this.title, this.price, this.productId, this.onPressed});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ProductCategoryJeanPage(productId: productId ,)));
      },
      child: Container(
          child:Column(
