...
import 'package:flutter_app_fashion/screens/categories/bag/product_bag_page.dart';
import 'package:flutter_app_fashion/screens/categories/bag/product_bag_page.dart';
...
class ProductCardBag extends StatelessWidget {
  ...
  ProductCardBag({this.imageUrl, this.title, this.price, this.productId, this.onPressed});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ProductCategoryBagPage(productId: productId ,)));
      },
      child: Container(
          child:Card(
            child: Container(
