...
class ProductCardShoe extends StatelessWidget {
  ...
  ProductCardShoe({this.imageUrl, this.title, this.price, this.productId, this.onPressed});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ProductCategoryShoePage(productId: productId ,)));
      },
      child: Container(
          child:Card(
            child: Container(
