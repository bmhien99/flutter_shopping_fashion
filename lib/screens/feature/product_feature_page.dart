...
class ProductFeaturePage extends StatefulWidget {
  final String? name;
  final String? imagePath;
  final double? price;
  final String? productId;

  ProductFeaturePage({this.imagePath, this.name, this.price, this.productId});
...
class _ProductPageState extends State<ProductFeaturePage> {
