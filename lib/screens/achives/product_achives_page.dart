...
class ProductAchivesPage extends StatefulWidget {
  final String? name;
  final String? imagePath;
  final double? price;
  final String? productId;

  ProductAchivesPage({this.imagePath, this.name, this.price, this.productId});
...
class _ProductPageState extends State<ProductAchivesPage> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => ListProductAchives()));
          },
        ),
        actions: [
          // IconButton(
