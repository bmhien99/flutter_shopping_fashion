...
class ProductCategoryShirtPage extends StatefulWidget {
  final String? name;
  final String? imagePath;
  final double? price;
  final String? productId;

  ProductCategoryShirtPage({this.imagePath, this.name, this.price, this.productId});
...
class _ProductPageState extends State<ProductCategoryShirtPage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => ListCategoryShirt()));
          },
        ),
        actions: [
          IconButton(
