...
class ProductCategoryShoePage extends StatefulWidget {
  final String? name;
  final String? imagePath;
  final double? price;
  final String? productId;

  ProductCategoryShoePage(
...
class _ProductPageState extends State<ProductCategoryShoePage> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => ListCategoryShoe()));
          },
        ),
        actions: [
          IconButton(
