...
class ProductCategoryDressPage extends StatefulWidget {
  final String? name;
  final String? imagePath;
  final double? price;
  final String? productId;

  ProductCategoryDressPage(
...
class _ProductPageState extends State<ProductCategoryDressPage> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => ListCategoryDress()));
          },
        ),
        actions: [
          IconButton(
